<footer>
			<div class="container_16">
				...
				<h4>Contact</h4>
				<p class="vcard">
					<span class="fn n name">
    <span class="given-name">Michael</span>
  <span class="family-name">Zeller</span>
</span>
 <span class="org organization">Fresh Venture (Healthy Goodness vending)</span><br/>
 <span class="etag">Email:</span>
 <a class="email" href="mailto:freshventuresmz@gmail.com">freshventuresmz@gmail.com</a><br/>
 <span class="etag">Cell:</span> <span class="tel organization">615 364 8478</span>
				</p>
				</div>	
				<div class="grid_8 push_1 margin-top-20">
